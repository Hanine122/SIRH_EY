...
public class TalentController : Controller
{
    ...
    // CALCULS
    // =========================
    private static int CalculatePerformanceScore(Collaborateur c) => TalentScoringEngine.CalculatePerformanceScore(c);

    private static int CalculatePotentielScore(Collaborateur c) => TalentScoringEngine.CalculatePotentielScore(c);

    private static NineBoxCategory Calculate9BoxCategory(int performance, int potentiel) => TalentScoringEngine.Calculate9BoxCategory(performance, potentiel);
}
